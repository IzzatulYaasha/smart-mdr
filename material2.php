...
<div class="w3-container w3-padding" id="contact">
    <div class="w3-content w3-containerx w3-white w3-round w3-card" style="max-width:600px">
		<a class="w3-right" href="material.php"><i class="fa fa-times-circle fa-2x"></i></a>
		<div class="w3-padding w3-margin">
			...
			<form method="post" action="recommend-done.php" >
				...
				<div class="w3-section" >
					...
					<?PHP if(($baju == "bka") OR ($baju == "bkd") OR ($baju == "bkb") OR ($baju == "bma") OR ($baju == "bmb") ) { ?>
					...
					<?PHP if(($baju == "bka") OR ($baju == "bkb") OR ($baju == "bke") OR ($baju == "bma") OR ($baju == "bmb") ) { ?>
					<div class="w3-row w3-border w3-padding">
						<div class="w3-col s4">
						<input class="w3-radio" type="radio" name="material" value="Satin" <?PHP if($baju == "bke") echo "checked";?>>
						Satin
						</div>
					...
					<?PHP if(($baju == "bka") OR ($baju == "bke") OR ($baju == "bmb") ) { ?>				
					<div class="w3-row w3-border w3-padding">
						<div class="w3-col s4">
					...
					<?PHP if(($baju == "bkc") OR ($baju == "bma") ) { ?>
					<div class="w3-row w3-border w3-padding">
						<div class="w3-col s4">
						<input class="w3-radio" type="radio" name="material" value="Batik" <?PHP if($baju == "bkc") echo "checked";?>>
						Batik
						</div>
					...
					<div class="w3-row w3-border w3-padding">
						<div class="w3-col s4">
						<input class="w3-radio" type="radio" name="material" value="Rayon">
						Rayon
						</div>
						
						<div class="w3-col s8">
						Soft and lightweight, providing comfort for everyday use and casualoccasions.
						</div>
					</div>
					<?PHP } ?>
					...
					<div class="w3-row w3-border w3-padding">
						<div class="w3-col s4">
						<input class="w3-radio" type="radio" name="material" value="Crepe" >
						Crepe
						</div>
						
						<div class="w3-col s8">
						Soft and drapes well, suitable for semi-formal and formal occasions.
						</div>
					</div>
					<?PHP } ?>
					...
					<div class="w3-row w3-border w3-padding">
						<div class="w3-col s4">
						<input class="w3-radio" type="radio" name="material" value="Jacquard" >
						Jacquard
						</div>
						
						<div class="w3-col s8">
						Textured fabric with intricate patterns, great for formal wear and special events.
						</div>
					</div>
					<?PHP } ?>
				...
				<hr class="w3-clear">
				<input type="hidden" name="baju" value="<?PHP echo $baju;?>">
