...
<div class="" >
	...
	<div class=" w3-center w3-text-white w3-padding-16">
		<span class="w3-xlarge"><b>PROFILE</b></span><br>
	</div>
    ...
    <div class="w3-content w3-container w3-white w3-round w3-card" style="max-width:500px">
		<div class="w3-padding">
			...
			<form method="post" action="" >
				...
				<button type="submit" class="w3-button w3-wide w3-block w3-padding-large w3-teal w3-margin-bottom w3-round"><b>UPDATE</b></button>
